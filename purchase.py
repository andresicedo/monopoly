...
class Purchase:
    def purchase(self, players: Players, turn):
        ...
        if board.monopoly[str(position.current(turn))] in bank.properties:
            ...
            if user_input == "1":
                if assets.user_account_balance[0] > bank.properties[board.monopoly[str(position.current(turn))]]:
                    ...
                    if user_input == "1":
                        ...
                        print(f"BALANCE: {players.players[0]}, your current account balance is ${assets.user_account_balance[0]}\n")
                        assets.user_account_balance[0] -= int(bank.properties[board.monopoly[str(position.current(turn))]])
                        ...
                        print(f"Your updated balance is ${assets.user_account_balance[0]}\n")
    ...
    def bot_purchase(self, players: Players, bot_turn):
        ...
        if board.monopoly[str(bot_position.bot_current(bot_turn))] in bank.properties:
            if assets.bot_account_balance[0] > bank.properties[board.monopoly[str(bot_position.bot_current(bot_turn))]]:
                ...
                if user_input == "1":
                    ...
                    assets.bot_account_balance[0] -= bank.properties[board.monopoly[str(bot_position.bot_current(bot_turn))]]
                    ...
                    print(f"{players.players[1]} Balance: ${assets.bot_account_balance[0]}\n")
                    print(f"{players.players[0]} will roll next\n")
                if user_input == "2":
                    print(f"{players.players[1]} decided not to purchase property.\n")
                    print(f"{players.players[0]} will roll next\n")     
